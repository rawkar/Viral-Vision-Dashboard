...
function hanteraData(data) {
    ...
    uppdateraElement(klickInlagg, data.linkedin.clicks.totalClicks, 'Data saknas');
    uppdateraElement(klickInlaggChange, data.linkedin.clicks.changeLastMonth, 'Data saknas');
