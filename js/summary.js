...
function hanteraData(data) {
    uppdateraElement(antalFoljare, data.summary.totalFollowers, 'Kunde inte ladda antal följare');
    uppdateraElement(nyaFoljare, data.summary.newFollowers, 'Data saknas');
    uppdateraElement(okningFoljare, data.summary.growthPercentage, 'Data saknas');
    uppdateraElement(bastaInlagg, data.summary.clicks.bestPost, 'Data saknas'); // Uppdaterad sökväg
    uppdateraElement(klickInlagg, data.summary.clicks.totalClicks, 'Data saknas');
    uppdateraElement(klickInlaggChange, data.summary.clicks.changeLastMonth, 'Data saknas');
